...
// GlaxWeather SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (GlaxWeatherSDK::test)
...
{
    private const SDK_CLASS = 'GlaxWeatherSDK';
    ...
    private const SDK_BASE = 'glaxweather_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../glaxweather_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
