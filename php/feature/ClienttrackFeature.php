...
// GlaxWeather SDK clienttrack feature
...
class GlaxWeatherClienttrackFeature extends GlaxWeatherBaseFeature
{
    ...
    public function PostConstruct(GlaxWeatherContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'GlaxWeather-SDK';
