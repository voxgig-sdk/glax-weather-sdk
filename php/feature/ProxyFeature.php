...
class GlaxWeatherProxyFeature extends GlaxWeatherBaseFeature
{
    ...
    public function init(GlaxWeatherContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (GlaxWeatherContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
