...
// GlaxWeather SDK timeout feature
...
class GlaxWeatherTimeoutFeature extends GlaxWeatherBaseFeature
{
    ...
    private function _with_timeout(GlaxWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(GlaxWeatherContext $_ctx, float $ms): void
    {
        $client = $this->client;
