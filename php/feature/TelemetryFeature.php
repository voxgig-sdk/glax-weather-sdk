...
// GlaxWeather SDK telemetry feature
...
class GlaxWeatherTelemetryFeature extends GlaxWeatherBaseFeature
{
    ...
    private function _close(GlaxWeatherContext $ctx, bool $ok): void
    {
