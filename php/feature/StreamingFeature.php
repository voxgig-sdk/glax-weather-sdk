...
// GlaxWeather SDK streaming feature
...
class GlaxWeatherStreamingFeature extends GlaxWeatherBaseFeature
{
    ...
    private function _iterate(GlaxWeatherResult $result): \Generator
    {
    ...
    private function _streamable(GlaxWeatherContext $ctx): bool
    {
