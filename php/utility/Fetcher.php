...
// GlaxWeather SDK utility: fetcher

class GlaxWeatherFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; GlaxWeatherSDK/1.0)';
    ...
    public static function call(GlaxWeatherContext $ctx, string $fullurl, array $fetchdef): array
    {
