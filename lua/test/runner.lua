...
function runner.env_override(m)
  local live = runner.getenv("GLAXWEATHER_TEST_LIVE")
  local override = runner.getenv("GLAXWEATHER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("GLAXWEATHER_TEST_EXPLAIN")
