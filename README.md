...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/glax-weather` | `npm install @voxgig-sdk/glax-weather` |
| Python | `voxgig-sdk-glax-weather` | `pip install voxgig-sdk-glax-weather` |
| PHP | `voxgig-sdk/glax-weather` | `composer require voxgig-sdk/glax-weather` |
| Golang | `github.com/voxgig-sdk/glax-weather-sdk/go` | `go get github.com/voxgig-sdk/glax-weather-sdk/go` |
| Ruby | `voxgig-sdk-glax-weather` | `gem install voxgig-sdk-glax-weather` |
| Lua | `voxgig-sdk-glax-weather` | `luarocks install voxgig-sdk-glax-weather` |
