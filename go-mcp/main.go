// Command GlaxWeather-mcp is an MCP server exposing the GlaxWeather
// SDK as MCP tools.
//
// Two tools are registered:
//
//	GlaxWeather_list  — list records of an entity
//	GlaxWeather_load  — load a single record of an entity
//
