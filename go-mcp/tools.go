...
type Args struct {
	Entity string         `json:"entity" jsonschema:"weather"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.GlaxWeatherSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "glax-weather_list",
		Description: "List records from GlaxWeather. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "glax-weather_load",
		Description: "Load a single record from GlaxWeather. " +
...
func runOp(client *sdk.GlaxWeatherSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.GlaxWeatherSDK, name string) (sdk.GlaxWeatherEntity, error) {
	switch strings.ToLower(name) {
	case "weather":
		return client.Weather(nil), nil
