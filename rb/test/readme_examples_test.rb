...
#      offline in seeded test mode (GlaxWeatherSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "GlaxWeather_sdk.rb")
  SDK_CLASS = "GlaxWeatherSDK"
