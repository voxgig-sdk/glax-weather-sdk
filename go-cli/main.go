// Command GlaxWeather-cli is a CLI + REPL for the GlaxWeather SDK,
...
const prompt = "glax-weather"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "weather"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      GLAX_WEATHER_APIKEY (api key), GLAX_WEATHER_BASE (base url override)")
