...
func registerSDKWords(r *eng.Registry, client *sdk.GlaxWeatherSDK) {
...
func runOp(client *sdk.GlaxWeatherSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
