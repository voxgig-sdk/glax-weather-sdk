# GlaxWeather SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions GlaxWeatherSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both GlaxWeatherSDK(...) and GlaxWeatherSDK.test(...) become
#      GlaxWeatherSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "glaxweather_sdk"
_SDK_CLASS = "GlaxWeatherSDK"
