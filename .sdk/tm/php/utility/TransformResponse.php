...
// GlaxWeather SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class GlaxWeatherTransformResponse
{
    public static function call(GlaxWeatherContext $ctx): mixed
    {
        ...
        $transform = GlaxWeatherHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
