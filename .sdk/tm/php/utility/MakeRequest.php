...
// GlaxWeather SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class GlaxWeatherMakeRequest
{
    public static function call(GlaxWeatherContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new GlaxWeatherResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new GlaxWeatherResponse($fetched);
        } else {
