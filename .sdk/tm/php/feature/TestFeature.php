...
// GlaxWeather SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class GlaxWeatherTestFeature extends GlaxWeatherBaseFeature
{
    ...
    public function init(GlaxWeatherContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (GlaxWeatherContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = GlaxWeatherParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (GlaxWeatherContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(GlaxWeatherContext $ctx, $op, $args): array
    {
