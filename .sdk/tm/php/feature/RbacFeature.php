...
class GlaxWeatherRbacFeature extends GlaxWeatherBaseFeature
{
    ...
    private function _required(GlaxWeatherContext $ctx): ?string
    {
    ...
    private function _reject(GlaxWeatherContext $ctx, string $required): void
    {
    ...
    private function _track(GlaxWeatherContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
