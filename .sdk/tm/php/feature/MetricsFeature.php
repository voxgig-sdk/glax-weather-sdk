...
// GlaxWeather SDK metrics feature
...
class GlaxWeatherMetricsFeature extends GlaxWeatherBaseFeature
{
    ...
    private function _record(GlaxWeatherContext $ctx, bool $ok): void
    {
