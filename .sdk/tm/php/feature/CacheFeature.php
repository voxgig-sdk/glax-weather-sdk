...
class GlaxWeatherCacheFeature extends GlaxWeatherBaseFeature
{
    ...
    private function _through(GlaxWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
