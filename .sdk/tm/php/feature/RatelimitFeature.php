...
// GlaxWeather SDK ratelimit feature
...
class GlaxWeatherRatelimitFeature extends GlaxWeatherBaseFeature
{
    ...
    private function _acquire(GlaxWeatherContext $ctx): void
    {
    ...
    private function _track(GlaxWeatherContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
