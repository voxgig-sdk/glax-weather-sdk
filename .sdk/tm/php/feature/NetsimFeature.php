...
// GlaxWeather SDK netsim feature
...
class GlaxWeatherNetsimFeature extends GlaxWeatherBaseFeature
{
    ...
    private function _simulate(GlaxWeatherContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(GlaxWeatherContext $ctx, array $applied): void
    {
        $client = $this->client;
