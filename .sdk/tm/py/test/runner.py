...
class GlaxWeatherTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = GlaxWeatherTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = GlaxWeatherTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = GlaxWeatherTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
