...
from core.control import GlaxWeatherControl
...
class GlaxWeatherContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, GlaxWeatherSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, GlaxWeatherResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, GlaxWeatherResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return GlaxWeatherError(code, msg, self)
