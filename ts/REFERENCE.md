# GlaxWeather TypeScript SDK Reference

Complete API reference for the GlaxWeather TypeScript SDK.
...
```ts
new GlaxWeatherSDK(options?: object)
```
...
#### `GlaxWeatherSDK.test(testopts?, sdkopts?)`
...
**Returns:** `GlaxWeatherSDK` instance in test mode.
...
Return the parent `GlaxWeatherSDK` instance.
